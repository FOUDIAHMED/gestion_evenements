                ...
                <div class="container-fluid">
                    <div class="row">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <form action="/categoryEvent" method="post">
                            @csrf
                            @foreach($categories as $category)
                            <a class="nav-item" role="presentation">
                                <button class="nav-link active" name="cat" id="design-tab" value="{{$category->id}}" data-bs-toggle="tab" data-bs-target="#design-tab-pane" type="submit" role="tab" aria-controls="design-tab-pane" aria-selected="true">{{$category->name}}</button>
                            </a>
                            @endforeach
                            </form>
                        </ul>
                                            ...
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        ...
                                                        <span class="badge bg-design rounded-pill ms-auto">{{$event->nombre_places}}</span>
                                                    </div>
